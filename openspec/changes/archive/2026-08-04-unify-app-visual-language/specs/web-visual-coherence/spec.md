...
No prior `openspec/specs/web-visual-coherence/` exists; all requirements are
`ADDED`. Scope: `apps/web` auth, dashboard, history, and certify-wizard
surfaces, aligned to the landing/verify reference recipe.
