...
describe("VerifyPage (spec: web-public-verify — No-Auth Access)", () => {
  ...
  it("renders a dark 'no disponible' state, mounting neither component, when the feature flag is disabled", async () => {
    ...
    expect(
      screen.getByText("La verificación pública no está disponible en este momento."),
    ).toBeInTheDocument();
