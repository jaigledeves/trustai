 ...
 *
 * CERTIFIED converges onto the app's canonical emerald recipe (spec:
 * web-visual-coherence — "Canonical Success/Error Visual Semantics"); the
 * previous `dark:` pair is dropped as dead CSS (app is light-only). READY
 * (sky) and ANCHORING (amber) are sanctioned distinct in-progress states and
 * are untouched.
 */
