    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <select
          ...
          className="h-8 w-full min-w-0 rounded-lg border border-input bg-background px-2.5 py-1 text-sm text-foreground outline-none transition-colors focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 sm:w-56"
        >
          <option value="" className="bg-background text-foreground">
            {historyDictionary.list.stateFilterAll}
          </option>
          {STATES.map((stateOption) => (
            <option key={stateOption} value={stateOption} className="bg-background text-foreground">
